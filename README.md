...
下载需要对应文献的有效全文访问权限。机构用户请按学校或机构提供的方式完成授权；使用 WebVPN 时，请填写学校提供的完整知网访问网址并完成登录。
...
勾选论文后，在“导出类型”中直接选择 **Excel、CSV 或 Zotero**，再点击“导出所选”。文件自动保存在主窗口设置的目录。Zotero 文件可通过 Zotero 的“文件 → 导入”添加到文献库。
